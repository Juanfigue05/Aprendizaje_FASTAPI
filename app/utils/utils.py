...
def save_uploaded_document(file):
    ...
    # Tipos MIME válidos (Listado de tipos de archivos estandares)
    valid_content_types = [
        'application/pdf',
    ...
    # Tamaño máximo: 10 MB se puede aumentar el tamaño?
    ...
    unique_filename = f"{uuid.uuid4()}{extension}" # uuid identificador unico universal
